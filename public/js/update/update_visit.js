...
let updateVisitForm = document.getElementById('update-visit-date-form-ajax');
...
updateVisitForm.addEventListener("submit", function (e) {
    ...
    let inputID = document.getElementById("input-visit-date");
...
function updateRow(data, idValue) {
    ...
    for (let i = 0, row; row = table.rows[i]; i++) {
        ...
        if (table.rows[i].getAttribute("data-value") == idValue) {
            ...
            td1.innerHTML = parsedData[0].visitDate;
        }
    }
}
